...
export interface EmployeeMenuProps {
  ...
  setCurrentTab?: (tab: 'home' | 'calendar' | 'team' | 'approvals' | 'profile') => void;
}

export default function EmployeeMenu({ visible, onClose, onNavigate, setCurrentTab }: EmployeeMenuProps) {
  ...
  const handleTabSelect = (tab: 'home' | 'calendar' | 'team' | 'approvals' | 'profile') => {
    onClose();
    setTimeout(() => {
      setCurrentTab?.(tab);
    }, 320);
      ...
      <Animated.View style={[styles.menuOverlay, { paddingTop: insets.top, backgroundColor: colors.card, transform: [{ translateX: slideAnim }] }]}>
        ...
        <View style={[styles.menuHeader, { borderBottomColor: colors.borderLight }]}>
          ...
          <View style={styles.profileInfo}>
            <Text style={[styles.profileName, { color: colors.textPrimary }]}>{user?.displayName || 'Testing'}</Text>
            <Text style={[styles.profileRole, { color: colors.textSecond }]} numberOfLines={1}>{user?.userName || 'testing@cybervault.in'}</Text>
          </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: Math.max(insets.bottom, 16) + 90 }}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_profile', { source: 'menu' })}
          >
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('attendance_history', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
              <MaterialCommunityIcons name="history" size={22} color={colors.brand} />
            </View>
            <Text style={[styles.menuItemText, { color: colors.textPrimary }]}>Attendance History</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_apply_leave', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
              <MaterialCommunityIcons name="calendar-text-outline" size={22} color={colors.brand} />
            </View>
            <Text style={[styles.menuItemText, { color: colors.textPrimary }]}>Apply Leave</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_create_claim', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
              <MaterialCommunityIcons name="receipt-outline" size={22} color={colors.brand} />
            </View>
            <Text style={[styles.menuItemText, { color: colors.textPrimary }]}>Apply Claim</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_assets', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
              <MaterialCommunityIcons name="package-variant-closed" size={22} color={colors.brand} />
            </View>
            <Text style={[styles.menuItemText, { color: colors.textPrimary }]}>My Assets</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_change_password', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
          ...
          <TouchableOpacity
            style={[styles.menuItem, { backgroundColor: colors.card }]}
            activeOpacity={0.7}
            onPress={() => handleNavigate('employee_help', { source: 'menu' })}
          >
            <View style={[styles.menuIconWrap, { backgroundColor: colors.iconBg }]}>
