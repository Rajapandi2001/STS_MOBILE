...
export default function ManagerCreateLeaveScreen({
  onBack,
  onNavigate,
  initialParams,
}: ManagerCreateLeaveScreenProps) {
  ...
  useEffect(() => {
    const onBackPress = () => {
      ...
      onNavigate?.('manager_leave_management');
      return true;
    };
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  Alert.alert('Success', 'Leave request submitted successfully!', [
                    { 
                      text: 'OK', 
                      onPress: () => onNavigate?.('manager_leave_management', { newLeave: newLog }) 
                    }
                  ]);
                }}
                activeOpacity={0.8}
